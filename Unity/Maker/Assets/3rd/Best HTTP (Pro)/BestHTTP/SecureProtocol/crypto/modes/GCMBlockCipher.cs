...
using ElephantGames.Org.BouncyCastle.Crypto.Modes.Gcm;
using ElephantGames.Org.BouncyCastle.Crypto.Parameters;
using ElephantGames.Org.BouncyCastle.Crypto.Utilities;
using ElephantGames.Org.BouncyCastle.Utilities;

namespace ElephantGames.Org.BouncyCastle.Crypto.Modes
{
    /// <summary>
