...
using BestHTTP.Authentication;
    ...
    using ElephantGames.Org.BouncyCastle.Crypto.Tls;
#endif
        ...
        private void Connect()
        {
            ...
            if (Stream == null)
            {
                ...
                if (isSecure)
                {
                    ...
                    {
                        var handler = new TlsClientProtocol(Client.GetStream(), new ElephantGames.Org.BouncyCastle.Security.SecureRandom());
